...
router.get("/admindashboards",async function(req,res) {
   console.log("dxfghjk");
   var data1;
   var data2;
   var data3;
...
router.get("/doctordashboards",async function(req,res) {
   var data1;
   var data2;
   var data3;
   var data4;
...
}); router.get("/studentdashboards",async function(req,res) {
   var data1;
   var data2;
   var data3;
   var data4;
