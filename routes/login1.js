...
router.get("/feedback/:id/:id1/:id2", async function(req,res){
   var data5= req.params.id;
   var e=req.params.id1;
   var p=req.params.id2;
 res.render("feedback",{data5,e,p});
});  
router.get("/feedbacks/:id/:id1/:id2", async function(req,res){
   var data5= req.params.id;
   var e=req.params.id1;
   var p=req.params.id2;
 res.render("feedbacks",{data5,e,p});
}); 
router.get("/feedbackd/:id/:id1/:id2", async function(req,res){
   var data5= req.params.id;
   var e=req.params.id1;
   var p=req.params.id2;
 res.render("feedbackd",{data5,e,p});
}); 
...
//feeedback
router.post("/feedback/:id/:id1/:id2",async(req,res)=>{
   var data5=req.params.id;
...
router.post("/feedbacks/:id/:id1/:id2",async(req,res)=>{
   var data5=req.params.id;
...
router.post("/feedbackd/:id/:id1/:id2",async(req,res)=>{
   var data5=req.params.id;
