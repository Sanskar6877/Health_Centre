...
router.post('/prescribe/:id/:id1/:id2',async (req, res, next)=> {
   ...
   var name1=req.params.id1;
   var name3=req.params.id2;
   collection.findByIdAndUpdate({_id: req.params.id1},req.body,(err, data) => { 
...
router.post("/note/:id",async function(req,res){
  ...
  let info = await transporter.sendMail({
      ...
      to: "cse210001063@iiti.ac.in", // list of receivers email Id's
      subject: "Health center timings updates " , // Subject line
      text: "Today updates in health center timings  as foloows: " +" "+ check.note +" For further information please contact us as gfg882004@gmail.com" , // plain text body
  });
   ...
   try{ 
      ...
      if(check.phone===req.body.phone){
         ...
         //     data4 = user_data2;
             ...
             res.render("display",{data1,data2,data3,data4,data5,data6,data7,name1,data8,data9,data10}); 
  ...
  try{ 
     ...
     if(check.phone===req.body.phone){
        ...
        //     data4 = user_data2;
            ...
            res.render("displayd",{data1,data2,data3,data4,data5,data6,data7,name1,data8,data9,data10}); 
